...
<!--Variable Nombre-->		
		...
		<!--Variable Telefono-->
            ...
            <label for="LetraEP" class="Formulario-Label">Telefono</label>
            <div class="Variable-grupo-input">
            <input type="text" class="formulario-input" name="LetraEP" id="LetraEP" placeholder="Telefono del Trabajador">
            </div>
        </div>
        <!--Variable contraseña-->
